...
if __name__ == "__main__":
    ...
    save_dir = os.path.join(base_dir, 'checkpoints_' + 'dropout')
        ...
        with pt.defaults_scope(activation_fn=tf.nn.relu, phase=phase):
            y_pred, loss = x_pretty. \
                ...
                conv2d(kernel=3, depth=3, name='layer_conv2',
                       batch_normalize=True). \
                max_pool(kernel=2, stride=2). \
                conv2d(kernel=3, depth=3, name='layer_conv3',
                       batch_normalize=True). \
                max_pool(kernel=2, stride=2). \
                conv2d(kernel=5, depth=3, name='layer_conv4',
                       batch_normalize=True). \
                max_pool(kernel=2, stride=2). \
                conv2d(kernel=5, depth=3, name='layer_conv5',
                       batch_normalize=True). \
                max_pool(kernel=2, stride=2). \
                flatten(). \
